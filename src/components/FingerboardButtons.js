...
function FingerboardButtons(props){
  ...
  return(
    <Box direction='row-responsive' gap='medium' margin='small' flex='grow' justify='center'>
      <Box direction={'column'} gap={'small'} id={'c-string'}>
      ...
      <Box direction={'column'} gap={'small'} id={'g-string'}>
      ...
      <Box direction={'column'} gap={'small'} id={'d-string'}>
      ...
      <Box direction={'column'} gap={'small'} id={'a-string'}>
